...
-- Script simplificado sin dependencia de tabla rotaciones
-- ============================================
...
CREATE TABLE IF NOT EXISTS retribuciones (
  ...
  detalles JSONB, -- Almacena el detalle de cada solicitud/rotación
  observaciones TEXT,
...
COMMENT ON COLUMN retribuciones.detalles IS 'JSON con el detalle de cada solicitud incluida en el cálculo';
